...
describe('DELETE /rest/packstationen', () => {
    ...
    test('Vorhandene Packstation loeschen', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Packstation loeschen, aber ohne Token', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Packstation loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/rest/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
    ...
    test('Vorhandene Packstation als "user" loeschen', async () => {
        // given
        const url = `/rest/60`;
