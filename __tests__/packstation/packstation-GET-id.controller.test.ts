...
import { type PackstationModel } from '../../src/packstation/rest/packstation-get.controller.js';
...
describe('GET /rest/:id', () => {
    ...
    test('Packstation zu vorhandener ID', async () => {
        ...
        // when
        const { status, headers, data }: AxiosResponse<PackstationModel> =
    ...
    test('Keine Packstation zu nicht-vorhandener ID', async () => {
        // given
    ...
    test('Keine Packstation zu falscher ID', async () => {
        // given
        const url = `/${idFalsch}`;
    ...
    test('Packstation zu vorhandener ID mit ETag', async () => {
        // given
